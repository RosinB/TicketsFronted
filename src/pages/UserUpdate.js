...
const HeaderTitle = () => {
    return (<div className="bg-gradient-to-r from-blue-700 via-teal-600 to-teal-800  px-6 py-4 ">
...
const FormFields = ({ inputFields, user, handleInputChange, fieldErrors, getFieldIcon }) => {
    return (
