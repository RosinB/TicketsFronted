...
import { Timer, CalendarDays, Music, TrendingUp } from 'lucide-react'; 
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="grid md:grid-cols-2 gap-8">
                {/* 熱門演唱會圖表 */}
                <Chart popularityData={popularityData}/>

                {/* 倒數計時區塊 */}
                <div className="bg-white rounded-xl p-6 shadow-xl border border-gray-100">
                    <UpComingTitle />
                    {/* 倒數內容 */}
                    <UpComingSalesList upcomingSales={upcomingSales} timers={timers}/>
                </div>
            </div>
        </div>
    );
...
const UpComingSalesList =({upcomingSales,timers})=>{
...
const UpComingTitle=()=>{
    return(  <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
